#!/usr/bin/env python3
"""Legacy shim: `uv run scripts/search_openalex.py` → `scieflow research search openalex`.
...
if __name__ == "__main__":
    forward("uv run scripts/search_openalex.py", "scieflow.research.search.openalex")
